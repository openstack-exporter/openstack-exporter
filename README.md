...
openstack_nova_quota_cores|tenant="admin",type="in_use"
openstack_nova_quota_fixed_ips quota_fixed_ips|tenant="admin",type="in_use"
openstack_nova_quota_floating_ips quota_floating_ips|tenant="admin",type="in_use"
openstack_nova_quota_injected_file_content_bytes quota_injected_file_content_bytes|tenant="admin",type="in_use"
openstack_nova_quota_injected_file_path_bytes quota_injected_file_path_bytes|tenant="admin",type="in_use"
openstack_nova_quota_injected_files quota_injected_files|tenant="admin",type="in_use"
openstack_nova_quota_instances quota_instances|tenant="admin",type="in_use"
openstack_nova_quota_key_pairs quota_key_pairs|tenant="admin",type="in_use"
openstack_nova_quota_metadata_items quota_metadata_items|tenant="admin",type="in_use"
openstack_nova_quota_ram quota_ram|tenant="admin",type="in_use"
openstack_nova_quota_security_group_rules quota_security_group_rules|tenant="admin",type="in_use"
openstack_nova_quota_security_groups quota_security_groups|tenant="admin",type="in_use"
openstack_nova_quota_server_group_members quota_server_group_members|tenant="admin",type="in_use"
openstack_nova_quota_server_groups quota_server_groups|tenant="admin",type="in_use"
