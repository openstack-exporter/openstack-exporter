...
openstack_neutron_quota_floatingip|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                                                                      |1 (float)|Current usage of floating ips for the tenant
openstack_neutron_quota_network|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of networks for the tenant
openstack_neutron_quota_port|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                                            |1 (float)|Current usage of ports for the tenant
openstack_neutron_quota_rbac_policy|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                              |1 (float)|Current usage of rbac policies for the tenant
openstack_neutron_quota_security_group_rule|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                    |1 (float)|Current usage of security group rules for the tenant
openstack_neutron_quota_security_group|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of security groups for the tenant
openstack_neutron_quota_subnetpool|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of subnet pools for the tenant
openstack_neutron_quota_subnet|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="used"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of subnets for the tenant
...
openstack_nova_quota_cores|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                                                      |1 (float)|Current usage of cores for the tenant
openstack_nova_quota_fixed_ips quota_fixed_ips|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of fixed IPs for the tenant
openstack_nova_quota_floating_ips quota_floating_ips|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                            |1 (float)|Current usage of floating IPs for the tenant
openstack_nova_quota_injected_file_content_bytes quota_injected_file_content_bytes|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                              |1 (float)|Current usage of injected file content bytes for the tenant
openstack_nova_quota_injected_file_path_bytes quota_injected_file_path_bytes|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                    |1 (float)|Current usage of injected file path bytes for the tenant
openstack_nova_quota_injected_files quota_injected_files|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of injected files for the tenant
openstack_nova_quota_instances quota_instances|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of instances for the tenant
openstack_nova_quota_key_pairs quota_key_pairs|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of key pairs for the tenant
openstack_nova_quota_metadata_items quota_metadata_items|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of metadata items for the tenant
openstack_nova_quota_ram quota_ram|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                                              |1 (float)|Current usage of RAM for the tenant
openstack_nova_quota_security_group_rules quota_security_group_rules|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                            |1 (float)|Current usage of security group rules for the tenant
openstack_nova_quota_security_groups quota_security_groups|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                      |1 (float)|Current usage of security groups for the tenant
openstack_nova_quota_server_group_members quota_server_group_members|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                            |1 (float)|Current usage of server group members for the tenant
openstack_nova_quota_server_groups quota_server_groups|tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="in_use"                                                                                                                                                                                                                                                                          |1 (float)|Current usage of server groups for the tenant
