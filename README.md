...
Flags:
  ...
  -d, --disable-metric= ...      multiple --disable-metric can be specified in the format: service-metric (i.e: cinder-snapshots)
      ...
      --[no-]disable-service.instance-ha
                                 Disable the instance-ha service exporter in strict mode
...
openstack_masakari_segment| id="1",uuid="9e800031-6946-4b43-bf09-8b3d1cab792b",name="segment1",description="main segment",recovery_method="auto",service_type="COMPUTE"                                                                                                                                                                                       |1.0 (float)| Masakari failover segment info
openstack_masakari_host| id="1",uuid="083a8474-22c0-407f-b89b-c569134c3bfd",name="compute-01",failover_segment_id="9e800031-6946-4b43-bf09-8b3d1cab792b",failover_segment_name="segment1",type="COMPUTE_HOST",control_attributes="SSH"                                                                                                                       |1.0 (float)| Masakari host info
openstack_masakari_host_on_maintenance| uuid="083a8474-22c0-407f-b89b-c569134c3bfd",name="compute-01",failover_segment_id="9e800031-6946-4b43-bf09-8b3d1cab792b"                                                                                                                                                                                                 |1.0 (float)| Host on maintenance (1=on maintenance, 0=available)
openstack_masakari_host_reserved| uuid="083a8474-22c0-407f-b89b-c569134c3bfd",name="compute-01",failover_segment_id="9e800031-6946-4b43-bf09-8b3d1cab792b"                                                                                                                                                                                                       |1.0 (float)| Host reserved (1=reserved, 0=not reserved)
openstack_masakari_up| region="RegionOne"                                                                                                                                                                                                                                                                                                             |1.0 (float)| Service status (1=up, 0=down)
