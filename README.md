...
openstack_placement_resource_provider_trait| hostname="compute-01", trait="TRAIT_NAME"                                                                                                                                                                                                                                                             |1.0 (float)| Resource trait informational metric, one metric per hostname + trait
