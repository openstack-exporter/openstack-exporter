...
func CollectCache(
	...
	for _, cloud := range clouds {
		...
		for _, service := range enabledServices {
			...
			exp, err := enableExporterFunc(service, prefix, cloud, disabledMetrics, endpointType, collectTime, disableSlowMetrics, disableDeprecatedMetrics, disableCinderAgentUUID, domainID, tenantID, novaMetadataMapping, nil, 1000, logger)
			if err != nil {
