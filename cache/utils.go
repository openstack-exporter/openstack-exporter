...
func CollectCache(
	enableExporterFunc func(
		string, string, string, []string, string, bool, bool, bool, bool, bool, string, string, *utils.LabelMappingFlag, int, func() (string, error), *slog.Logger,
	...
	for _, cloud := range clouds {
		...
		for _, service := range services {
			...
			exp, err := enableExporterFunc(service, prefix, cloud, disabledMetrics, endpointType, collectTime, disableSlowMetrics, disableDeprecatedMetrics, disableCinderAgentUUID, enableIronicDriverInfo, domainID, tenantID, novaMetadataMapping, dnsConcurrentCount, uuidGenFunc, logger)
			if err != nil {
