...
func CollectCache(
	enableExporterFunc func(
		string, string, string, []string, string, bool, bool, bool, bool, string, string, *utils.LabelMappingFlag, *utils.ExtraLabelsFlag, func() (string, error), *slog.Logger,
	...
	for _, cloud := range clouds {
		...
		for _, service := range enabledServices {
			...
			exp, err := enableExporterFunc(service, prefix, cloud, disabledMetrics, endpointType, collectTime, disableSlowMetrics, disableDeprecatedMetrics, disableCinderAgentUUID, domainID, tenantID, novaMetadataMapping, extraLabels, nil, logger)
			if err != nil {
