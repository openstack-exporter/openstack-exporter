...
func EnableExporter(service, prefix, cloud string, disabledMetrics []string, endpointType string, collectTime bool, disableSlowMetrics bool, disableDeprecatedMetrics bool, disableCinderAgentUUID bool, domainID string, tenantID string, novaMetadataMapping *utils.LabelMappingFlag, ironicAdditionalLabels string, uuidGenFunc func() (string, error), logger *slog.Logger) (*OpenStackExporter, error) {
	exporter, err := NewExporter(service, prefix, cloud, disabledMetrics, endpointType, collectTime, disableSlowMetrics, disableDeprecatedMetrics, disableCinderAgentUUID, domainID, tenantID, novaMetadataMapping, ironicAdditionalLabels, uuidGenFunc, logger)
	if err != nil {
		return nil, err
	}
	return &exporter, nil
...
func NewExporter(name, prefix, cloud string, disabledMetrics []string, endpointType string, collectTime bool, disableSlowMetrics bool, disableDeprecatedMetrics bool, disableCinderAgentUUID bool, domainID string, tenantID string, novaMetadataMapping *utils.LabelMappingFlag, ironicAdditionalLabels string, uuidGenFunc func() (string, error), logger *slog.Logger) (OpenStackExporter, error) {
	...
	exporterConfig := ExporterConfig{
		...
		IronicAdditionalLabels:   ironicAdditionalLabels,
	}
