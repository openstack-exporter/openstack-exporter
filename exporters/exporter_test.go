...
func (suite *BaseOpenStackTestSuite) SetupTest() {
	...
	exporter, err := NewExporter(suite.ServiceName, suite.Prefix, cloudName, []string{}, "public", false, false, false, false, "", "", novaMetadataMapping, 10, []string{}, func() (string, error) {
