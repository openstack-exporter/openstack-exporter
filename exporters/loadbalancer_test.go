...
# HELP openstack_loadbalancer_loadbalancer_active_connections loadbalancer_active_connections
# TYPE openstack_loadbalancer_loadbalancer_active_connections gauge
openstack_loadbalancer_loadbalancer_active_connections{id="607226db-27ef-4d41-ae89-f2a800e9c2db",name="best_load_balancer",project_id="e3cd678b11784734bc366148aa37580e"} 10
# HELP openstack_loadbalancer_loadbalancer_bytes_in loadbalancer_bytes_in
# TYPE openstack_loadbalancer_loadbalancer_bytes_in counter
openstack_loadbalancer_loadbalancer_bytes_in{id="607226db-27ef-4d41-ae89-f2a800e9c2db",name="best_load_balancer",project_id="e3cd678b11784734bc366148aa37580e"} 1024
# HELP openstack_loadbalancer_loadbalancer_bytes_out loadbalancer_bytes_out
# TYPE openstack_loadbalancer_loadbalancer_bytes_out counter
openstack_loadbalancer_loadbalancer_bytes_out{id="607226db-27ef-4d41-ae89-f2a800e9c2db",name="best_load_balancer",project_id="e3cd678b11784734bc366148aa37580e"} 2048
# HELP openstack_loadbalancer_loadbalancer_request_errors loadbalancer_request_errors
# TYPE openstack_loadbalancer_loadbalancer_request_errors counter
openstack_loadbalancer_loadbalancer_request_errors{id="607226db-27ef-4d41-ae89-f2a800e9c2db",name="best_load_balancer",project_id="e3cd678b11784734bc366148aa37580e"} 2
...
# HELP openstack_loadbalancer_loadbalancer_total_connections loadbalancer_total_connections
# TYPE openstack_loadbalancer_loadbalancer_total_connections counter
openstack_loadbalancer_loadbalancer_total_connections{id="607226db-27ef-4d41-ae89-f2a800e9c2db",name="best_load_balancer",project_id="e3cd678b11784734bc366148aa37580e"} 500
