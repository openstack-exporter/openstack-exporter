...
openstack_nova_agent_state{UpdatedAt="2012-09-19 06:55:34 +0000 UTC",adminState="disabled",disabledReason="test2",hostname="host1",id="2",service="nova-compute",zone="nova"} 1
...
openstack_nova_agent_state{UpdatedAt="2012-10-29 13:42:05 +0000 UTC",adminState="enabled",disabledReason="",hostname="host2",id="3",service="nova-scheduler",zone="internal"} 0
