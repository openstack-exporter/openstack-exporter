...
func CreatePortBaremetal(t *testing.T, client *gophercloud.ServiceClient, node *nodes.Node) (*ports.Port, error) {
...
func DeletePortBaremetal(t *testing.T, client *gophercloud.ServiceClient, port *ports.Port) {
